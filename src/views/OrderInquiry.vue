...
const columnDefs = computed(() => [
  ...
  { field: 'orderDate', headerName: 'Order Date', flex: 2, minWidth: 140, sortable: true },
  { field: 'productName', headerName: 'Product', flex: 2.5, minWidth: 130, sortable: true, filter: true },
  {
    field: 'amount',
    headerName: 'Amount (₩)',
    flex: 1.5,
  ...
  { field: 'shippingAddress', headerName: 'Shipping Address', flex: 3, minWidth: 160, sortable: false },
  {
  ...
  { field: 'trackingNumber', headerName: 'Tracking No.', flex: 2, minWidth: 130, sortable: false },
  {
    field: 'orderStatus',
